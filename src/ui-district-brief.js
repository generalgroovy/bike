...
button.addEventListener('click',()=>{const game=Game.lastInstance,d=game?.deliveryById(game.selectedDeliveryId);if(d&&game.briefDistrict?.(d.pickupDistrict)){last='';render();}});
registerUiTask('district-brief',render,{interval:120,hiddenInterval:1200});