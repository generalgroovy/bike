...
try {
  ...
  const city=GEOGRAPHIC_RULESETS.includes(record.ruleset)?decodeInnerRing(JSON.parse(readFileSync(new URL('../generated/berlin-inner-ring.json',import.meta.url),'utf8'))):undefined;
