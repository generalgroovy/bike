...
export class Game{
constructor({seed=createSeed(),city=BERLIN,width=city.width,height=city.height,initialize=true}={}){
  ...
  this.cityData=city.geographic?city:null;
  this.generateBerlin(city);this.deliveries=[];this.couriers=[];this._deliveryArrayRef=this.deliveries;this._courierArrayRef=this.couriers;
