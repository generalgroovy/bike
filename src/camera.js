...
export class Camera{
  ...
  visibleWorldBounds(marginPx=0){const a=this.screenToWorld(-marginPx,-marginPx),b=this.screenToWorld(this.viewWidth+marginPx,this.viewHeight+marginPx);return{x1:Math.min(a.x,b.x),y1:Math.min(a.y,b.y),x2:Math.max(a.x,b.x),y2:Math.max(a.y,b.y)};}
